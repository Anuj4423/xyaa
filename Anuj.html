...
<style>
  ...
  blockquote p b.merah {
    color: red
  }

  blockquote p b.kuning {
    color: yellow
  }

  blockquote p b.putih {
    padding-left: 3px;
    padding-right: 3px;
    background: white;
  }

  blockquote p b.garisputih {
    font-weight: 700;
    border-bottom: 2px solid white
  }

  blockquote p b.garismerah {
    font-weight: 700;
    border-bottom: 2px solid red
  }

  blockquote p b.gariskuning {
    font-weight: 700;
    border-bottom: 2px solid yellow
  }

  blockquote p:not(#opsL, #kalimat) {
    display: none;
  }

  blockquote p:not(#kalimat6ngetik) {
    text-align: center;
  }
  ...
  .swal2-modal {
    ...
    max-width: 320px;
    border-right: var(--bingkai-kanan);
    border-left: var(--bingkai-kiri);
    border-radius: 4px;
    top: -50px;
  }
...
<body>
  ...
  <div id="bodyblur">
    <!-- Wallpaper --><img src="./assets/pict.jpg" id="wallpaper" />
  ...
  <div id='Content'>
    ...
    <div id="cover">
      <!-- LOVE Button -->
      <label class='lovein'><svg class='line' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
    ...
    <div class="kumpulanstiker">
      ...
      <img src="./assets/hearthappy.gif" id="fotostiker" />
      <img src="./assets/bwa2.gif" id="fotostiker2" />
      <img src="./assets/mikir.gif" id="fotostiker3" />
      <img src="./assets/pandapanah.gif" id="fotostiker4" />
      <img src="./assets/emawh.gif" id="fotostiker5" />
      <img src="./assets/mmm.gif" id="fotostiker6" />
      <img src="./assets/ciumin.gif" id="fotostiker7" />
    </div>
    ...
    <div>
      <blockquote id='bq' data-text='&#9829;'>
        ...
        <!-- Content -->
        <p id="kalimat"><b class="alt">Hello <b class='garisputih' style='color:pink'>Youuu!</b> 😋</b><br><br>I have a
          question for you..</p>
        <p id="kalimat1"><b class="alt">Are You Gay?<br>? 😆</b></p>
        <!-- Rejected Message -->
        <div class="sembunyi">
          <img id="stikerditolak" src="./assets/weee.gif" />
          <span id="kataditolak">Yeah you are gay 😆</span>
        </div>
        <p id="kalimat2ngetikv2">Huaaaaa ,<br>I knew it 🥹🫣</p>
        <span id="kalpertanyaan">i know you are <b class='garisputih' style='color:pink'>gay <b class='garisputih'
            style='color:pink'>laaj kina baba</b></span>
        <p id="kalimat3ngetik"><b style='font-size:17px'>Yeaayy!! 🥳</b><br><br><b
            style='font-size:15px !important'>ja mardey <b class='garisputih' style='color:pink'>haam falera</b><br>
            😋😆💐<br><br><b class='garisputih' style='color:pink'>Xakaaa</b> gayyyyy </b></p>
    ...
    <div id="Tombol">
      ...
      <a id="Bn" onClick="btn='Bn';fungsibaru(btn)">No</a>

      <span id="penggantiBy" class="sembunyi">💌 chal jhuta</span>
      <span id="penggantiBn" class="sembunyi">once more</span>
    </div>

  </div>

  <!-- Jangan Edit Bagian Ini -->
  <script>const body = document.querySelector("body"); const swalst = Swal.mixin({ timer: 2777, allowOutsideClick: false, showConfirmButton: false, timerProgressBar: true, imageHeight: 90, }); audio = new Audio('' + linkmp3.src); const swals = Swal.mixin({ allowOutsideClick: false, cancelButtonColor: '#FF0040', imageWidth: 100, imageHeight: 100, }); const style = document.createElement('style'); var today = new Date(); var dd = String(today.getDate()).padStart(2, '0'); var mm = String(today.getMonth() + 1).padStart(2, '0'); var yyyy = today.getFullYear(); const monthNames = ["Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"]; today = dd + ' ' + monthNames[today.getMonth()] + ' ' + yyyy; function createHeart() { const heart = document.createElement("div"); heart.className = "fas fa-heart"; heart.style.left = (Math.random() * 90) + "vw"; heart.style.animationDuration = (Math.random() * 3) + 2 + "s"; body.appendChild(heart); } setInterval(function name(params) { var heartArr = document.querySelectorAll(".fa-heart"); if (heartArr.length > 100) { heartArr[0].remove() } }, 100);

    jumlahKlik = 0; ftganti = 0; fungsi = 0; ftfungsi = 0; fungsiAwal = 0; fungsitimer = 0; deffotostiker = fotostiker.src; Content.style = "opacity:1;margin-top:30vh;"; wallpaper.style = "opacity:0";
    document.getElementById("cover").onclick = function () { if (fungsiAwal == 0) { audio.play(); fungsiAwal = 1; cover.style = "transition:all .7s ease;opacity:0"; wallpaper.style = "transform: scale(1.5);"; ket.style = "opacity:0"; kot.style = "opacity:0"; setTimeout(mulainama, 500) } }
    let jumlahSkala = 1;
    ...
    function fungsibaru(btn) {
      ...
      if (fungtom != 1) {
        ...
        jumlahKlik++;
        jumlahSkala++;
      } else if (fungtom == 1) { fungsigamau(); jumlahKlik = 0 }

      if (jumlahKlik == 3 && fungtom != 1) {
        jumlahKlik = 0;
      }
    ...
    async function mulainama() {
      cover.style = "display:none"; ket.style = "display:none"; kot.style = "display:none";
    ...
    function prbhn() { if (opsLcheck == jumlahP - 1) { kecepatan = 30;/*var prg = document.getElementById("kalimat");prg.classList.add("kiri");*/ } }
    ...
    kecepatan = 30; vketik1 = kalimat.innerHTML; kalimat.innerHTML = "";
    function mulaiketik1() {
      kalimat.innerHTML = "";
      new TypeIt("#kalimat", {
        strings: [vketik1], startDelay: 1, speed: kecepatan, waitUntilVisible: true,
    ...
    function fungsimau() {
      Tombol.style = "";
      if (fungtom == 2) { document.getElementById("By").style = "transform:scale(0);transition:all .8s ease"; Tombol.style = "transform:scale(0);transition:all .8s ease"; }
      if (fungtom == 2) { }
      if (fungtom < 3) {
        setTimeout(function () {
          opsLclick = 1; myCheck();
    ...
    function muncultombol3() { resetPosisi(); fungtom = 3; By.innerHTML = "💌 Balas"; Bn.style = "display:none"; Tombol.style = "opacity:1;transform:scale(1)"; }
  </script>
</body>
